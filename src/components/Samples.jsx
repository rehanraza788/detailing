...
// Card component for displaying samples
function SampleCard({ title, items }) {
  return (
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-10">
      ...
      <div className="flex flex-col md:flex-row justify-center items-start gap-8">
        <SampleCard title="Sample - 1" items={sampleList1} />
        <SampleCard title="Sample - 2" items={sampleList2} />
      </div>
    </div>
  );
}
