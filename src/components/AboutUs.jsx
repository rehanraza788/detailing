...
const AboutUs = () => {
  return (
    <>
      ...
      <div>
        <h1 className="text-center font-bold mt-3  text-2xl sm:text-3xl text-gray-600">
      ...
      <div className="flex justify-center flex-wrap mt-4 gap-2">
        <div className=" sm:border-2 sm:border-gray-400  sm:w-1/2  p-3 text-gray-700 font-bold">
          <p>
          ...
          <p>
            ...
            match their exact needs & expectations, gaining reputation for their
            common sense solutions to structural steel detailing using 3D
            modelling software's
          </p>
        </div>
        <div className="sm:border-2 sm:border-gray-400 w-96">
          <img
      ...
      <div className="flex justify-center flex-wrap mt-4  gap-2">
        <div className="sm:border-2 sm:border-gray-400 sm:w-1/2 h-80 mt-3 p-3 text-gray-700 font-bold">
          <p>
            Arsalan Detailing Services provides industry leading steel detailing
            services. ADS is an innovative Structural Steel Detailing company
            committed to providing quality steel detailing services to the
        ...
        <div className="sm:border-2 sm:border-gray-400 w-96  h-80 mt-3">
          <img
