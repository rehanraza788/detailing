...
const services = [
  {
    ...
    description:
      "Comprehensive 3D modeling and detailed drawings for structural steel components including beams, columns, and connections.",
  ...
  },
  {
    ...
    description:
      "Specialized detailing for miscellaneous steel items including stairs, railings, platforms, and architectural elements.",
  ...
  },
  {
    ...
    description:
      "Expert design and detailing of pipe rack systems and support structures for industrial and commercial applications.",
  ...
  },
  {
    ...
    description:
      "Detailed material takeoffs and comprehensive bills of material for accurate project estimation and procurement.",
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              in structural steel detailing and fabrication.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-8 rounded-2xl text-center">
              ...
              <p className="text-gray-700 leading-relaxed">
                To establish ourselves as a trusted partner in structural steel
                detailing by leveraging our team's extensive experience to
                deliver exceptional quality and precision in every project.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-slate-50 to-slate-100 p-8 rounded-2xl text-center">
              ...
              <p className="text-gray-700 leading-relaxed">
                To build a world-class enterprise in professional steel
                detailing, combining our seasoned expertise with fresh
                innovation to become the preferred choice for structural
            ...
            <div className="bg-gradient-to-br from-zinc-50 to-zinc-100 p-8 rounded-2xl text-center">
              ...
              <p className="text-gray-700 leading-relaxed">
                To provide customer-focused, globally competitive steel
                detailing services through our team's proven expertise,
                cutting-edge technology, and commitment to structural
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Comprehensive steel detailing solutions tailored to meet your
      ...
      >
        <div className="max-w-4xl mx-auto text-center px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-100 mb-8">
            Bring your structural steel projects to our experienced team. We
            combine 15+ years of industry expertise with fresh innovation to
            deliver precision detailing solutions.
          </p>
